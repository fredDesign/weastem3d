  ...
  public getPresetConfigurations(): { [key: string]: NetworkConfiguration } {
    return {
      ...
      simple: {
        ...
        nodes: [
          { id: 0, position: [0, 0, 0], radius: 0.5, color: "#134d9c", connections: [1, 2] },
          { id: 1, position: [-2, 1, 0], radius: 0.4, color: "#134d9c", connections: [0, 3] },
          { id: 2, position: [2, 1, 0], radius: 0.4, color: "#134d9c", connections: [0, 4] },
          { id: 3, position: [-1, -1, 1], radius: 0.3, color: "#f97316", connections: [1] },
          { id: 4, position: [1, -1, 1], radius: 0.3, color: "#134d9c", connections: [2] },
        ],
      },
      complex: {
        version: "1.0.0",
